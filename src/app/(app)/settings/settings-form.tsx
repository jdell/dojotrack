  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <section className="space-y-5 rounded-xl border border-border bg-card p-6 shadow-sm">
        ...
        <Field label="Public page URL" hint="Your shareable club page (not editable).">
        ...
        <Field label="Logo URL" hint="Link to a square image used on your public page and emails.">
          <input
            type="url"
            value={form.logoUrl}
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Field label="Default martial art">
            <select
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Field label="Contact email">
            <input
              ...
              placeholder="hello@yourdojo.com"
              className={inputClass}
            />
          </Field>
          <Field label="Phone">
